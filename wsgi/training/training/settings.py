...
STATIC_URL = '/static/'
STATIC_ROOT = (os.path.join(os.environ['OPENSHIFT_REPO_DIR'], 'wsgi', 'static') if OPENSHIFT else
               os.path.join(PROJECT_DIR, 'local', 'static'))
STATICFILES_DIRS = (os.path.join(BASE_DIR, 'static'),)
TEMPLATE_DIRS = (os.path.join(BASE_DIR, 'templates'),)

# Media files
MEDIA_ROOT = (os.path.join(os.environ['OPENSHIFT_REPO_DIR'], 'wsgi', 'media') if OPENSHIFT else
